...
pub const PLACEHOLDER: Style = AnsiColor::BrightBlue.on_default();
...
pub enum Api {
    ...
    Trades {
        #[command(flatten)]
        creds: Credentials,
        /// The collection of words to be searched for.
        /// The minimum word length is two characters,
        /// noise words such as 'and', 'or' and 'the'
        /// are discarded. Most punctuation characters
        /// are discarded, the dash [-] and apostrophe
        /// ['] characters being the only exceptions.
        #[arg(short = 'S')]
        search_terms: Option<String>,

        /// File path for csv output. Leaving this out will output into stdout.
        #[arg(short = 'o')]
